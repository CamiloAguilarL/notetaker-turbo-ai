...
- A keyboard-only skip link targets the single main landmark on every product, loading, error, and authentication screen. These programmatic focus targets suppress the browser's container-sized outline, while interactive descendants retain their semantic focus rings.
